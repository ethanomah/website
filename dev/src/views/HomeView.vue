  ...
  <!-- <main> -->
    <div class="container-fluid info">
      <TransitionGroup 
        ...
        @enter="onEnter"
      >
        <h2 key="sentence1" data-index="1" class="sentence">I'm a <span class="age highlight">{{age.toFixed(12)}}</span> year old Associate Data Scientist at <span @click="tenableLink" class="link">Tenable</span></h2>
        <h2 key="sentence2" data-index="2" class="sentence">My main interests are in <span class="highlight">AI</span> and <span class="highlight">Machine Learning</span></h2>
        <h2 key="sentence3" data-index="3" class="sentence">The main technologies I use are <span class="highlight">Python</span>, <span class="highlight">Snowflake</span> and <span class="highlight">Databricks</span></h2>
